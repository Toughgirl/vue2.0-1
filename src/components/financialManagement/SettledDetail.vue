            ...
            <div class="ibox-content">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-lg-4"><label>采总额：</label>
                    <span>{{list.payable_amount}}</span>
                  </div>
                  <div class="col-lg-4"><label>退货总额：</label>
                    <span>{{list.receive_amount}}</span>
                  </div>
                  <div class="col-lg-4"><label>商品总额：</label>
                    <span>{{list.payable_amount}}</span>
                  </div>
                  <div class="col-lg-4"><label>应付/应收款：</label>
...
//              console.log(self.list)
        ...
        //列表
          $("#settledDetail").dataTable({
            ...
            "ajax": {
//              "url": "/Settlementpages",
              "url": store.state.baseUrl.data_serv_url+"/system/companySettlement/pages",
              "type": "POST",
