  ...
  function I(G, _) {
    ...
    function E(K, J) {
      ...
      function C() {
        ...
        //for (var C = 0; C < D.length; C++)if (D[C].name == J.skin)$.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"http://localhost:8080/static/My97DatePicker/skin/default/datepicker.css\" charset=\"" + D[C].charset + "\"/>");
        $.push("<script src=\"" + A + "calendar.js\"></script>");
        //$.push("<script src='http://localhost:8080/static/My97DatePicker/calendar.js'></script>");
